...
names(pares) <- c("12","13","14","23","24","34")
#pairs() com destaque para as observaçoes 9 e 16
...
sapply(pares,function(ij){
  ...
  lines(elip,col="blue4",lty=2,lwd=2)
  elip50 <- ellipse(cor(disp)[1,2],level=0.5,scale=apply(disp,2,sd),
                  centre=colMeans(disp))
  lines(elip50,col="#515ECC",lty=2)
  })
